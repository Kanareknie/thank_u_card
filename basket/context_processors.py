...
# Context processor to add the count of items in the user's
# basket to the template context.
# This allows us to display the number of items in the basket in the header or
# other parts of the site without having to manually
# pass this information from every view.
